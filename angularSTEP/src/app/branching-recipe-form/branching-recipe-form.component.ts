...
@Component({
  selector: 'app-branching-recipe-form',
  templateUrl: './branching-recipe-form.component.html',
  styleUrls: ['./branching-recipe-form.component.scss']
})
export class BranchingRecipeFormComponent implements OnInit {
  baseRecipe!: Recipe;
